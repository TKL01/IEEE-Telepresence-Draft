...
Fig. \ref{fig:clip} shows our web interface in action.
\begin{figure}[htbp]
    \centerline{\includegraphics[width=8.9cm]{images/clip.pdf}}
    \caption{Controlling the Husky via the web interface with the virtual joystick and the live camera image.}
    \label{fig:clip}
\end{figure}
